...
var work = {
  "jobs": [{
      ...
      "location": "Seattle, WA",
      "dates": "9/2015 - 8/2016",
      "description": "Business training program focusing on computer science " +
                     "and programming."
    },
    {
      ...
      "description": "Made espresso drinks as well as sandwiches in a " +
                     "geek-themed coffeehouse."
    },
    {
      "employer": "The Point",
      ...
      "description": "Trained new employees and managed front counter " +
                     "while making espresso drinks."
    }
  ]
};
...
bio.display = function() {
  ...
  $header.prepend(formatHTMLheaderName, formatHTMLheaderRole);
  $("#topContacts").append(formatHTMLmobile, formatHTMLemail, formatHTMLtwitter, formatHTMLgithub, formatHTMLlocation);
  $header.append(formatHTMLwelcomeMsg, formatHTMLbioPic, HTMLskillsStart);
  ...
  $("#footerContacts").append(formatHTMLmobile, formatHTMLemail, formatHTMLtwitter, formatHTMLgithub, formatHTMLlocation);
};
